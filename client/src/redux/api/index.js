...
export const getFacultyData = () => {
  return API.get("/api/faculty/getfacultydata");
};

export const getTestCount = () => API.get("/api/faculty/testcount");
export const getStudentCount = () => API.get("/api/faculty/studentcount");
export const getSubjectCount = () => API.get("/api/faculty/subjectcount");
