      ...
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          <div className="space-y-1">
            ...
            <div className="bg-[#515966] rounded-lg px-3 flex  items-center">
              <input
          ...
          <button
            type="submit"
            className="w-40 hover:scale-105 transition-all duration-150 rounded-lg flex items-center justify-center text-white text-base py-2 px-3 bg-[#04bd7d]">
            Login
          </button>
          {loading && (
            <Spinner
